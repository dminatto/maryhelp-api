...
var NotificacoesService = /** @class */ (function () {
    ...
    NotificacoesService.prototype.criaNotificacaoDeBoasVindas = function (idUsuario) {
    ...
    NotificacoesService.prototype.leNotificacao = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.marcaNotificacaoComoLida(id)];
...
exports.default = NotificacoesService;
